...
export default function UpdateForm() {
  ...
  const { updateVehicle, officesData, unitData } = useDataStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const vehicleId = location.state.vehicle.id
        await updateVehicle(vehicleId, formData, csrfToken);
    } catch (error) {
...
mapRef.current.setView([location.lat, location.lng], 14, { animate: true });
  ...
  return (
    <div className='vehiclesFormContainer'>
       <div className="vehiclesFormFlex">
        <div className='vehiclesFormWrapper'>
          ...
          <div className="vehiclesFormWrapper2">
          <span className='vehiclesFormBox'>
           ...
           <div className="vehiclesFormCheckbox">
              <span  className='vehiclesFormBox2'>
                <input 
                  type="checkbox" 
                  value="device"
           ...
           <button className='vehiclesFormAddBtn' onClick={handleSubmit}>Add Vehicle</button>
          </div>
       </div>
    </div>
  )
